define([], function() {
  ...
  Modelpicker.prototype.colorWasPicked = function() {
    return (this.pickedColor !== false);
  };

  Modelpicker.prototype.init = function() {
  ...
  Modelpicker.prototype._handleMouseMove = function(event) {
    var x, y, hex;
  ...
  Modelpicker.prototype._handleClick = function(event) {
    var x, y, hex;
  ...
  Modelpicker.prototype._handleMouseLeave = function(event) {
    if (this.pickedColor) {
  ...
  Modelpicker.prototype._hexColorFromXY = function(x, y) {
    var hue = (x / 194),
      sat = (y / 100),
      lit = .5,
      rgb,
